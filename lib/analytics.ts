...
import { computeSurveyTotalBudget } from "./surveyBudget";
import {
...
// Vive aquí (no en el Client Component) para que tanto la página de
// /admin/analitica como el export a Excel puedan construir exactamente los
// mismos datos sin duplicar las 10 consultas y los Maps de agregación.
